...
class PermissionInfoDialog : AppCompatDialogFragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        requestCode = requireArguments().getInt(REQUEST_CODE_KEY)
        permissions = requireArguments().getStringArray(PERMISSIONS_KEY) as Array<String>
        permissionType = requireArguments().getSerializable(PERMISSION_TYPE_KEY) as PermissionType
    }
